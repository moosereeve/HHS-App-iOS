...
@implementation HHSSHKConfigurator
 ...
 */
- (NSString*)appName {
    return [[NSBundle mainBundle] infoDictionary][@"Holliston High School"];
}

- (NSString*)appURL {
    return @"https://itunes.apple.com/us/app/holliston-high-school/id901020099?mt=8";
}
...
- (NSString*)twitterConsumerKey {
    return @"GdM43JmPsJXn4oWU8Yc0erez1";
}

- (NSString*)twitterSecret {
    return @"Ho6JM5O2yYVEWZ2v0t9zjmCBxOFKNn7xWbt4DMnKUxipcqFbTq";
}
// You need to set this if using OAuth, see note above (xAuth users can skip it)
- (NSString*)twitterCallbackUrl {
    return @"http://hhs.holliston.k12.ma.us";
}
