...
-(void)viewWillLayoutSubviews {
    ...
    const UIEdgeInsets insets = (self.automaticallyAdjustsScrollViewInsets) ? UIEdgeInsetsMake(65, 0.0, 0.0, 0.0) : UIEdgeInsetsZero;
